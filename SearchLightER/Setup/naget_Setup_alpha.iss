...
AppId={{E56CFCE4-3DCE-42A5-8657-820D7E249F4E}
AppName={#MyAppName}
...
[Files]
Source: "..\bin\{#MyPlatformArch}\Release\net8.0\{#MyPlatform}\publish\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\bin\{#MyPlatformArch}\Release\net8.0\{#MyPlatform}\publish\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
